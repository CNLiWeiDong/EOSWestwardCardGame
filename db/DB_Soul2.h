#ifndef TEMPLET_DB_Soul2_H
#define TEMPLET_DB_Soul2_H
#include <map>
#include <tuple>
#include <string>
#include <vector>
...
class DB_Soul2;
static DB_Soul2* DB_Soul2_instanse = nullptr;
class DB_Soul2
{
public:
static DB_Soul2* getInstanse()
{
    if(DB_Soul2_instanse)
        return  DB_Soul2_instanse;
        DB_Soul2_instanse = new DB_Soul2();
    return  DB_Soul2_instanse;
}
int getCount()
{
...
const DB_Soul2_Data& getDataById(int id)
{
