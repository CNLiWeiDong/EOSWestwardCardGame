#ifndef TEMPLET_DB_Soul4_H
#define TEMPLET_DB_Soul4_H
#include <map>
#include <tuple>
#include <string>
#include <vector>
...
class DB_Soul4;
static DB_Soul4* DB_Soul4_instanse = nullptr;
class DB_Soul4
{
public:
static DB_Soul4* getInstanse()
{
    if(DB_Soul4_instanse)
        return  DB_Soul4_instanse;
        DB_Soul4_instanse = new DB_Soul4();
    return  DB_Soul4_instanse;
}
int getCount()
{
...
const DB_Soul4_Data& getDataById(int id)
{
