#ifndef TEMPLET_DB_Soul3_H
#define TEMPLET_DB_Soul3_H
#include <map>
#include <tuple>
#include <string>
#include <vector>
...
class DB_Soul3;
static DB_Soul3* DB_Soul3_instanse = nullptr;
class DB_Soul3
{
public:
static DB_Soul3* getInstanse()
{
    if(DB_Soul3_instanse)
        return  DB_Soul3_instanse;
        DB_Soul3_instanse = new DB_Soul3();
    return  DB_Soul3_instanse;
}
int getCount()
{
...
const DB_Soul3_Data& getDataById(int id)
{
