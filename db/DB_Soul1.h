#ifndef TEMPLET_DB_Soul1_H
#define TEMPLET_DB_Soul1_H
#include <map>
#include <tuple>
#include <string>
#include <vector>
...
class DB_Soul1;
static DB_Soul1* DB_Soul1_instanse = nullptr;
class DB_Soul1
{
public:
static DB_Soul1* getInstanse()
{
    if(DB_Soul1_instanse)
        return  DB_Soul1_instanse;
        DB_Soul1_instanse = new DB_Soul1();
    return  DB_Soul1_instanse;
}
int getCount()
{
...
const DB_Soul1_Data& getDataById(int id)
{
