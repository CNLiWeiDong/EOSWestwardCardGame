#ifndef TEMPLET_DB_Soul6_H
#define TEMPLET_DB_Soul6_H
#include <map>
#include <tuple>
#include <string>
#include <vector>
...
class DB_Soul6;
static DB_Soul6* DB_Soul6_instanse = nullptr;
class DB_Soul6
{
public:
static DB_Soul6* getInstanse()
{
    if(DB_Soul6_instanse)
        return  DB_Soul6_instanse;
        DB_Soul6_instanse = new DB_Soul6();
    return  DB_Soul6_instanse;
}
int getCount()
{
...
const DB_Soul6_Data& getDataById(int id)
{
